...
base_materialized_var = materialized_var + model_base
base_table = materialized_table + model_base
base_view = materialized_view + model_base
base_ephemeral = materialized_ephemeral + model_base
ephemeral_with_cte = materialized_ephemeral + model_ephemeral_with_cte
ephemeral_view = materialized_view + model_ephemeral
ephemeral_table = materialized_table + model_ephemeral
incremental = materialized_incremental + model_incremental
